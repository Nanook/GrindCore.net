...
namespace GrindCore.Tests
{
    public sealed class CompressionBlockTests
    {
        ...
        [Theory]
        [InlineData(CompressionAlgorithm.Copy, 0, 0x10000, "8d572de6b2804494")]
        ...
        [InlineData(CompressionAlgorithm.Lzma2, 1, 0x1e5, "b4550df1c1bd0067")]
        [InlineData(CompressionAlgorithm.Lzma2, 5, 0x1e5, "3e6f77f9c11f4e70")]
        [InlineData(CompressionAlgorithm.Lzma2, 9, 0x1e5, "3e6f77f9c11f4e70")]
        [InlineData(CompressionAlgorithm.ZLib, 1, 0x3d3, "faf781046fb77de8")]
        [InlineData(CompressionAlgorithm.ZLib, 6, 0x305, "a3c36ab37f8f236d")]
        [InlineData(CompressionAlgorithm.ZLib, 9, 0x305, "a21b9fa33c110bc5")]
        [InlineData(CompressionAlgorithm.ZLibNg, 1, 0x4c4, "fc40654142efec69")]
        [InlineData(CompressionAlgorithm.ZLibNg, 6, 0x305, "a3c36ab37f8f236d")]
        [InlineData(CompressionAlgorithm.ZLibNg, 9, 0x305, "a21b9fa33c110bc5")]
        [InlineData(CompressionAlgorithm.ZStd, 1, 0x195, "3545b23ad651d5d4")]
        [InlineData(CompressionAlgorithm.ZStd, 3, 0x195, "3545b23ad651d5d4")]
        [InlineData(CompressionAlgorithm.ZStd, 22, 0x195, "3545b23ad651d5d4")]
        public void Data_ByteArray64KiB_BlockCompress(CompressionAlgorithm algorithm, int type, int size, string expected)
        {
            CompressionBlock block = CompressionBlockFactory.Create(algorithm, (CompressionType)type, _data64KiB.Length, false, CompressionVersion.Create(algorithm));
        ...
        [Theory]
        [InlineData(CompressionAlgorithm.Deflate, 1, 0x1000a, "f4a2740735a848e5")]
        [InlineData(CompressionAlgorithm.Deflate, 6, 0x1000a, "602832ca2a11542c")]
        [InlineData(CompressionAlgorithm.Deflate, 9, 0x1000a, "602832ca2a11542c")]
        [InlineData(CompressionAlgorithm.DeflateNg, 1, 0x10021, "a5ed03187d448a19")]
        [InlineData(CompressionAlgorithm.DeflateNg, 6, 0x10021, "e2f946756bf49fce")]
        [InlineData(CompressionAlgorithm.DeflateNg, 9, 0x1000a, "f4a2740735a848e5")]
        [InlineData(CompressionAlgorithm.FastLzma2, 1, 0x1000c, "b2cee4d81324c0e2")]
        ...
        [InlineData(CompressionAlgorithm.Lzma2, 1, 0x10007, "c93c02419eed314c")]
        [InlineData(CompressionAlgorithm.Lzma2, 6, 0x10007, "8a3d45bab1e3772d")]
        [InlineData(CompressionAlgorithm.Lzma2, 10, 0x10007, "8a3d45bab1e3772d")]
        [InlineData(CompressionAlgorithm.ZLib, 1, 0x10010, "306fb18b107697be")]
        [InlineData(CompressionAlgorithm.ZLib, 6, 0x10010, "e6f25d701c2ebb19")]
        [InlineData(CompressionAlgorithm.ZLib, 9, 0x10010, "cf6bcf32107b4790")]
        [InlineData(CompressionAlgorithm.ZLibNg, 1, 0x10021, "687553b61e121c29")]
        [InlineData(CompressionAlgorithm.ZLibNg, 6, 0x10021, "750a3decaa561361")]
        [InlineData(CompressionAlgorithm.ZLibNg, 9, 0x10010, "ae8890c171895efb")]
        [InlineData(CompressionAlgorithm.ZStd, 1, 0x1000a, "4b9f7d6be30a4eca")]
        [InlineData(CompressionAlgorithm.ZStd, 3, 0x1000a, "4b9f7d6be30a4eca")]
        [InlineData(CompressionAlgorithm.ZStd, 22, 0x1000a, "4b9f7d6be30a4eca")]
        public void DataNonCompressible_ByteArray64KiB_BlockCompress(CompressionAlgorithm algorithm, int type, int size, string expected)
        {
            CompressionBlock block = CompressionBlockFactory.Create(algorithm, (CompressionType)type, _dataNC64KiB.Length, false, CompressionVersion.Create(algorithm));
            byte[] compressed = BufferPool.Rent(block.RequiredCompressOutputSize);
        ...
        [Theory]
#if IS_32BIT
        [InlineData(CompressionAlgorithm.Brotli, 1, 0x84d, "25be05c704cb5995")]
        [InlineData(CompressionAlgorithm.FastLzma2, 1, 0x5e5, "bc53adaf025e726e")]
        ...
        [InlineData(CompressionAlgorithm.Lzma2, 1, 0x636, "eca2b056732b6c26")]
        [InlineData(CompressionAlgorithm.ZLib, 1, 0x200c, "c43831d20deadb6b")]
        [InlineData(CompressionAlgorithm.ZLibNg, 1, 0x2651, "8b0b438386b0c1f5")]
        [InlineData(CompressionAlgorithm.ZStd, 1, 0x83a, "8a7fd9bf458ad52a")]
#else
        [InlineData(CompressionAlgorithm.Copy, 0, 0x10000, "cfd90e2b5db1ff5d")]
        [InlineData(CompressionAlgorithm.Brotli, 1, 0x84d, "25be05c704cb5995")]
        [InlineData(CompressionAlgorithm.Brotli, 4, 0x5d1, "2b444156a4305ae3")]
        [InlineData(CompressionAlgorithm.Brotli, 11, 0x4fa, "bd7a15fc895f1b65")]
        [InlineData(CompressionAlgorithm.FastLzma2, 1, 0x5e5, "bc53adaf025e726e")]
        ...
        [InlineData(CompressionAlgorithm.Lzma2, 1, 0x636, "eca2b056732b6c26")]
        [InlineData(CompressionAlgorithm.Lzma2, 5, 0x605, "9ac9ca397bdbf54b")]
        [InlineData(CompressionAlgorithm.Lzma2, 9, 0x647, "1b1484110fe9391a")]
        [InlineData(CompressionAlgorithm.ZLib, 1, 0x200c, "c43831d20deadb6b")]
        [InlineData(CompressionAlgorithm.ZLib, 6, 0xcc8, "aa99d2252c2f6606")]
        [InlineData(CompressionAlgorithm.ZLib, 9, 0xba1, "2b9ecf7dce8e81ce")]
        [InlineData(CompressionAlgorithm.ZLibNg, 1, 0x2651, "8b0b438386b0c1f5")]
        [InlineData(CompressionAlgorithm.ZLibNg, 6, 0xbe7, "bd93e4482eb778cb")]
        [InlineData(CompressionAlgorithm.ZLibNg, 9, 0xba1, "2b9ecf7dce8e81ce")]
        [InlineData(CompressionAlgorithm.ZStd, 1, 0x83a, "8a7fd9bf458ad52a")]
        [InlineData(CompressionAlgorithm.ZStd, 3, 0x7f0, "8723d465c72e2e88")]
        [InlineData(CompressionAlgorithm.ZStd, 22, 0x5c0, "6775dd2c3d7c5222")]


#endif
        public void Text_ByteArray64KiB(CompressionAlgorithm algorithm, int type, int size, string expected)
        {
            CompressionBlock block = CompressionBlockFactory.Create(algorithm, (CompressionType)type, _text64KiB.Length, false, CompressionVersion.Create(algorithm));
            byte[] compressed = BufferPool.Rent(block.RequiredCompressOutputSize);
        ...
        [Theory]
#if IS_32BIT
        [InlineData(CompressionAlgorithm.Brotli, 1, 0x1, "5896bb9a27ab7ba5")]
        [InlineData(CompressionAlgorithm.FastLzma2, 1, 0x6, "d8018fa1b17508d8")]
        [InlineData(CompressionAlgorithm.Lz4, 1, 0x1, "e934a84adb052768")]
        [InlineData(CompressionAlgorithm.Lzma, 1, 0x5, "00f4f72fb7a8c648")]
        [InlineData(CompressionAlgorithm.Lzma2, 1, 0x1, "e934a84adb052768")]
        [InlineData(CompressionAlgorithm.ZLib, 1, 0x8, "2bc964c3d0162760")]
        [InlineData(CompressionAlgorithm.ZLibNg, 1, 0x8, "2bc964c3d0162760")]
        [InlineData(CompressionAlgorithm.ZStd, 1, 0x9, "9fccd29d986b864f")]
#else
        [InlineData(CompressionAlgorithm.Copy, 0, 0x0, "ef46db3751d8e999")]
        [InlineData(CompressionAlgorithm.Brotli, 1, 0x1, "5896bb9a27ab7ba5")]
        [InlineData(CompressionAlgorithm.Brotli, 4, 0x1, "5896bb9a27ab7ba5")]
        [InlineData(CompressionAlgorithm.Brotli, 11, 0x1, "5896bb9a27ab7ba5")]
        [InlineData(CompressionAlgorithm.FastLzma2, 1, 0x6, "d8018fa1b17508d8")]
        ...
        [InlineData(CompressionAlgorithm.Lzma2, 1, 0x1, "e934a84adb052768")]
        [InlineData(CompressionAlgorithm.Lzma2, 5, 0x1, "e934a84adb052768")]
        [InlineData(CompressionAlgorithm.Lzma2, 9, 0x1, "e934a84adb052768")]
        [InlineData(CompressionAlgorithm.ZLib, 1, 0x8, "2bc964c3d0162760")]
        [InlineData(CompressionAlgorithm.ZLib, 6, 0x8, "65f2e912ed28c1ed")]
        [InlineData(CompressionAlgorithm.ZLib, 9, 0x8, "31edcf2ea90ea820")]
        [InlineData(CompressionAlgorithm.ZLibNg, 1, 0x8, "2bc964c3d0162760")]
        [InlineData(CompressionAlgorithm.ZLibNg, 6, 0x8, "65f2e912ed28c1ed")]
        [InlineData(CompressionAlgorithm.ZLibNg, 9, 0x8, "31edcf2ea90ea820")]
        [InlineData(CompressionAlgorithm.ZStd, 1, 0x9, "9fccd29d986b864f")]
        [InlineData(CompressionAlgorithm.ZStd, 3, 0x9, "9fccd29d986b864f")]
        [InlineData(CompressionAlgorithm.ZStd, 22, 0x9, "9fccd29d986b864f")]
#endif
        public void Text_ByteArrayEmpty(CompressionAlgorithm algorithm, int type, int size, string expected)
        {
            CompressionBlock block = CompressionBlockFactory.Create(algorithm, (CompressionType)type, 0, false, CompressionVersion.Create(algorithm));
