...
namespace GrindCore.Tests
{
    public sealed class CompressionStreamTests
    {
        ...
        [InlineData(CompressionStreamType.Deflate, CompressionLevel.Fastest, 0x180c, "a478196d4ec0ce87")]
        [InlineData(CompressionStreamType.Deflate, CompressionLevel.Optimal, 0x101c, "05003b313010d159")]
        [InlineData(CompressionStreamType.Deflate, CompressionLevel.SmallestSize, 0xb9b, "080ef351410b77ac")]
        [InlineData(CompressionStreamType.GZip, CompressionLevel.Fastest, 0x181e, "daf6da5a28571ca9")]
        [InlineData(CompressionStreamType.GZip, CompressionLevel.Optimal, 0x102e, "496e961ba3a1ac07")]
        [InlineData(CompressionStreamType.GZip, CompressionLevel.SmallestSize, 0xbad, "b2f20d23bf119caa")]
        [InlineData(CompressionStreamType.ZLib, CompressionLevel.Fastest, 0x1812, "50fc7c1aa897bb15")]
        [InlineData(CompressionStreamType.ZLib, CompressionLevel.Optimal, 0x1022, "d12362dcfa27fc10")]
        ...
        [InlineData(CompressionStreamType.Deflate, CompressionLevel.Optimal, 0x3b966a, "c668fabe6e6e9235", "ee055254ac0ba773")]
        ...
        [InlineData(CompressionStreamType.GZip, CompressionLevel.Optimal, 0x3b967c, "c668fabe6e6e9235", "ebe0cfc94d32bc81")]
        ...
        [InlineData(CompressionStreamType.ZLib, CompressionLevel.Optimal, 0x3b9670, "c668fabe6e6e9235", "faaa5ff1fa9c1a20")]
        ...
        public void Data_ByteArray64KiB_Zlib_Compress()
        {
            ...
            Assert.Equal(0x3d3, sz);
            Assert.Equal("d94ee8404fc070f8", result);
        ...
        [InlineData(4, 0x3d3, "3e74a6f73cae570e")]
        [InlineData(5, 0x3d3, "3e74a6f73cae570e")]
        [InlineData(6, 0x3d3, "d94ee8404fc070f8")]
        ...
        [InlineData(4, 0, false, 0x3cd, "eefbb1f99743a612")] //Normal
        [InlineData(4, 0, true, 0x3d3, "3e74a6f73cae570e")] //Normal
        [InlineData(4, 1, false, 0x3cd, "eefbb1f99743a612")] //Filtered
        [InlineData(4, 1, true, 0x3d3, "3e74a6f73cae570e")] //Filtered
        ...
        [InlineData(5, 0, false, 0x3cd, "eefbb1f99743a612")] //Normal
        [InlineData(5, 0, true, 0x3d3, "3e74a6f73cae570e")] //Normal
        [InlineData(5, 1, false, 0x3cd, "eefbb1f99743a612")] //Filtered
        [InlineData(5, 1, true, 0x3d3, "3e74a6f73cae570e")] //Filtered
        ...
        [InlineData(6, 0, false, 0x3cd, "eefbb1f99743a612")] //Normal
        [InlineData(6, 0, true, 0x3d3, "d94ee8404fc070f8")] //Normal
        [InlineData(6, 1, false, 0x3cd, "eefbb1f99743a612")] //Filtered
        [InlineData(6, 1, true, 0x3d3, "d94ee8404fc070f8")] //Filtered
