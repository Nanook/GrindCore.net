...
namespace GrindCore.Tests
{
    public sealed class CompressionStreamTests
    {
        ...
        [Theory]
#if IS_32BIT
        [InlineData(CompressionAlgorithm.Brotli, CompressionType.Fastest, 0x84d, "25be05c704cb5995", null)]
        [InlineData(CompressionAlgorithm.Deflate, CompressionType.Fastest, 0x1db4, "2464d64063e022ba", null)]
        [InlineData(CompressionAlgorithm.DeflateNg, CompressionType.Fastest, 0x264c, "728b6f680101e18d", null)]
        //[InlineData(CompressionAlgorithm.Lz4, CompressionType.Fastest, 0x16e8, "a0783a6c336c8bd9", null)]
        [InlineData(CompressionAlgorithm.Lzma, CompressionType.Fastest, 0x632, "1ee9e334582493e9", null)]
        [InlineData(CompressionAlgorithm.Lzma2, CompressionType.Fastest, 0x636, "eca2b056732b6c26", null)]
        [InlineData(CompressionAlgorithm.FastLzma2, CompressionType.Fastest, 0x5e5, "cdd2efd3865069b2", null)]
        [InlineData(CompressionAlgorithm.ZLib, CompressionType.Fastest, 0x1dba, "bdd8b43a296a44ad", null)]
        [InlineData(CompressionAlgorithm.ZLibNg, CompressionType.Fastest, 0x2652, "f2324065e2e34d09", null)]
        [InlineData(CompressionAlgorithm.ZStd, CompressionType.Fastest, 0x827, "6227887e1bc483a0", null)]
#else
