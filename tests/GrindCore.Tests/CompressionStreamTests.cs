...
#else
        [InlineData(CompressionAlgorithm.Brotli, CompressionType.Fastest, 0x860, "4565a78bfb006340")]
...
#else
        [InlineData(CompressionAlgorithm.Brotli, CompressionType.Fastest, 0x209, "9aeff4be079e6ed5")]
