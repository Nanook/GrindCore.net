...
public sealed class BrotliStream : Stream, IStreamStack
{
    ...
    {
        _grindCoreStream = new GrindCoreBrotliStream(baseStream, new CompressionOptions
        {
    ...
    /// <param name="leaveOpen">Whether to leave the base stream open when disposing</param>
    public BrotliStream(Stream baseStream, CompressionMode mode, int compressionLevel = 6, bool leaveOpen = false)
    {
