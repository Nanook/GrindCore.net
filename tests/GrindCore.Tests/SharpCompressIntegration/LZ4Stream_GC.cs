...
public sealed class LZ4Stream : Stream, IStreamStack
{
    ...
    {
        _grindCoreStream = new GrindCoreLz4Stream(baseStream, new CompressionOptions
        {
    ...
    /// <param name="leaveOpen">Whether to leave the base stream open when disposing</param>
    public LZ4Stream(Stream baseStream, CompressionMode mode, int compressionLevel = 6, bool leaveOpen = false)
    {
