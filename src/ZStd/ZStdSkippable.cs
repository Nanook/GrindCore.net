...
namespace Nanook.GrindCore.ZStd
{
    ...
    /// 
    /// This class supports multiple ZStd versions via the <see cref="CompressionVersion"/> parameter.
    ...
    /// </remarks>
    public static class ZStdSkippable
    {
        /// <summary>
        ...
        [CLSCompliant(false)]
        public static unsafe int WriteSkippableFrame(byte[] destination, byte[] source, uint magicVariant, CompressionVersion? version = null)
        {
            if (destination == null)
            ...
            bool useV152 = version != null && version.Index == 1;
            ...
            fixed (byte* srcPtr = source)
            {
                ...
                if (useV152)
                {
                    result = Interop.ZStd_v1_5_2.SZ_ZStd_v1_5_2_WriteSkippableFrame(
                        dstPtr, (UIntPtr)destination.Length, srcPtr, (UIntPtr)source.Length, magicVariant);
                ...
                {
                    result = Interop.ZStd.SZ_ZStd_v1_5_7_WriteSkippableFrame(
                        dstPtr, (UIntPtr)destination.Length, srcPtr, (UIntPtr)source.Length, magicVariant);
        ...
        /// <summary>
        /// Writes a skippable frame containing custom user data with span overloads.
        /// </summary>
        ...
        /// <exception cref="InvalidOperationException">Thrown when the write operation fails.</exception>
        [CLSCompliant(false)]
        public static unsafe int WriteSkippableFrame(Span<byte> destination, ReadOnlySpan<byte> source, uint magicVariant, CompressionVersion? version = null)
        {
            if (magicVariant > MaxVariant)
                throw new ArgumentOutOfRangeException(nameof(magicVariant), $"Magic variant must be between 0 and {MaxVariant}");
        ...
        [CLSCompliant(false)]
        public static unsafe int ReadSkippableFrame(byte[] destination, byte[] source, out uint magicVariant, CompressionVersion? version = null)
        {
            if (destination == null)
                throw new ArgumentNullException(nameof(destination));
            if (source == null)
            ...
            fixed (byte* srcPtr = source)
            {
                ...
                if (useV152)
                {
                    result = Interop.ZStd_v1_5_2.SZ_ZStd_v1_5_2_ReadSkippableFrame(
                        dstPtr, (UIntPtr)destination.Length, &variant, srcPtr, (UIntPtr)source.Length);
                    if (Interop.ZStd.SZ_ZStd_v1_5_2_IsError(result) != 0)
                    {
                        IntPtr errNamePtr = Interop.ZStd.SZ_ZStd_v1_5_2_GetErrorName(result);
                        string errorName = Marshal.PtrToStringAnsi(errNamePtr) ?? "Unknown error";
                ...
                {
                    result = Interop.ZStd.SZ_ZStd_v1_5_7_ReadSkippableFrame(
                        dstPtr, (UIntPtr)destination.Length, &variant, srcPtr, (UIntPtr)source.Length);
                    if (Interop.ZStd.SZ_ZStd_v1_5_7_IsError(result) != 0)
                    {
                        IntPtr errNamePtr = Interop.ZStd.SZ_ZStd_v1_5_7_GetErrorName(result);
        ...
        /// <exception cref="InvalidOperationException">Thrown when the read operation fails.</exception>
        [CLSCompliant(false)]
        public static unsafe int ReadSkippableFrame(Span<byte> destination, ReadOnlySpan<byte> source, out uint magicVariant, CompressionVersion? version = null)
        {
            bool useV152 = version != null && version.Index == 1;
        ...
        public static unsafe bool IsSkippableFrame(byte[] buffer, CompressionVersion? version = null)
        {
            if (buffer == null)
            ...
            {
                if (useV152)
                    return Interop.ZStd_v1_5_2.SZ_ZStd_v1_5_2_IsSkippableFrame(bufPtr, (UIntPtr)buffer.Length) != 0;
                else
                    return Interop.ZStd.SZ_ZStd_v1_5_7_IsSkippableFrame(bufPtr, (UIntPtr)buffer.Length) != 0;
            }
        }
        ...
        public static unsafe bool IsSkippableFrame(ReadOnlySpan<byte> buffer, CompressionVersion? version = null)
        {
            bool useV152 = version != null && version.Index == 1;
