...
namespace Nanook.GrindCore.ZStd
{
    ...
    public class ZStdSeekableStream_v1_5_7 : Stream
    {
        ...
        public ZStdSeekableStream_v1_5_7(Stream stream, int maxFrameSize = 1024 * 1024, int compressionLevel = 3, bool leaveOpen = false)
        {
            if (stream == null)
            ...
            _encoder = new ZStdSeekableEncoder_v1_5_7(bufferSize, (uint)maxFrameSize, compressionLevel, 1);
